    ...
    <div class="envor-content">
        ...
        <div id="layerslider" class="envor-layerslider" style="height: 500px;">
          ...
          <div class="ls-layer" style="transition3d: 1,4,5,11; transition2d: 2,8,30;">
            ...
            <div class="envor-layerslider-block ls-s1" style="top: 300px; left: 15px; transition2d: all; slidedelay: 6000; durationin: 1000; easingin: easeOutExpo;">
              <h3>LET'S </h3>
              <h2>Create</h2>
              <p>your growth starategy together</p>
            </div>
          </div>
          <!--LayerSlider layer-->
              ...
              <div class="envor-wrapper" id="clients-testimonials">
                ...
                <article class="envor-testimonials-1">
                  <div class="envor-testimonials-inner">
                    ...
                    <p class="author">- Naga Raju,<span> Accounts Manager</span></p>
                ...
                <article class="envor-testimonials-1">
                  <div class="envor-testimonials-inner">
                    ...
                    <p class="author">- Muthu Krishnan, <span> Senior Accountant</span></p>
                    <i class="fa fa-quote-left"></i>
                    <i class="fa fa-quote-right"></i>
                  </div>
                <!--
                ...
                <article class="envor-testimonials-1">
                  <div class="envor-testimonials-inner">
                    ...
                    <p class="author">- Kalaivani Naidu, <span> Head - Accounts</span></p>
                    <i class="fa fa-quote-left"></i>
                    <i class="fa fa-quote-right"></i>
                  </div>
                <!--
      ...
      <section class="envor-section envor-section-align-center">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <h2>our group of<strong> Companies</strong></h2>
              <div class="envor-relative" id="our-partners" >
                <div class="envor-partner-logo"><div class="inner"><img src="img/basstechs.png" alt=""><span class="helper"></span></div></div>
                <div class="envor-partner-logo"><div class="inner"><img src="img/careerasan.png" alt=""><span class="helper"></span></div></div>
