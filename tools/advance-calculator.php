          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="envor-desktop-breadscrubs-inner">
                <a href="../index.php">Home</a><i class="fa fa-angle-double-right"></i><a href="advance-calculator.php">Calculator</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div>
            <div class="col-lg-3 col-md-3">
              <nav class="envor-side-navi">
                <ul>
                  <li><i class="glyphicon glyphicon-arrow-right"></i> <a href="simple-calculator.php">INCOME TAX CALCULATOR</a></li>
                  <li class="active"><i class="glyphicon glyphicon-arrow-right"></i> <a href="advance-calculator.php">ADVANCE CALCULATOR</a></li>
                </ul>
              </nav>
            </div>
