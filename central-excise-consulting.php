...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <meta name="description" content="Bass Biz offers excise consulting services including excise registration, excise return filing, excise audit, excise dealer"/>
    <meta name="abstract" content="Bass Biz excise tax consulting team offers excise registration, excise return, excise dealer registration, excise dealer return"/>
    <meta name="keywords" content="excise consultant, excise registration, excise return, excise audit, duty, chennai, trichy, salem"/>
    ...
    <title> Central Excise Consultant | Excise Registration | Excise Audit | Excise Returns  | Bass Biz </title>
    ...
    <div class="envor-content">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-9">
              <h1>Central Excise Consulting</h1>
            </div>
          </div>
        </div>
      <!--
      ...
      <section class="envor-section envor-section-align-center">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <h2><strong>CENTRAL EXCISE CONSULTING</strong></h2>
            ...
            <div class="col-lg-6 col-md-6 envor-section-align-left">
              ...
              <p align="justify">Bass Biz has dedicated team of accounting professional to take care of your accounting and book-keeping services. Bass Biz assists business owners to save cost and time in terms of placing efficient system of accounts. Bass Biz accounting and book-keeping team enables you to have accurate books of accounts.</p>
              <p> <ul>
                      <li><font color="orange"><i class="fa fa-caret-right"></i></font> <a href="service-tax-consulting.php"> Service Tax Consulting</a></li>
                      <li><font color="orange"><i class="fa fa-caret-right"></i></font> <a href="sales-tax-consulting.php"> Sales Tax Consulting</a></li>
                      <li><font color="orange"><i class="fa fa-caret-right"></i></font> <a href="central-excise-consulting.php"> Central Excise Consulting</a></li>
                      <li><font color="orange"><i class="fa fa-caret-right"></i></font> <a href="income-tax-consulting.php"> Income Tax Consulting</a></li>
                  </ul>   
              </p>
            </div>
          </div>
