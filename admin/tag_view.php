  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          ...
          <!-- New Post -->
                 ...
                 <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" id="new_tag" class="modal fade">
          ...
          <div>
           <br>
              ...
              <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" id="edit_tag" class="modal fade">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                          <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
    ...
    <script src="js/tag_view.js" > </script>
