  ...
  function fnFormatDetails ( oTable, nTr )
    ...
    jQuery.ajax( {
          ...
          success: function(data) {
            ...
            CKEDITOR.instances.update_content.setData( data );
            }
    ...
    e.preventDefault();
    var messageLength = CKEDITOR.instances['update_content'].getData();
    if( !messageLength ) {
    ...
    e.preventDefault();
    var messageLength = CKEDITOR.instances['add_content'].getData();
    if( !messageLength ) {
        alert( 'Please Enter Contents!');
    }
