var EditableTable = function () {
    ...
    return {
		  ...
		  function fnFormatDetails ( oTable, nTr )
      {
          ...
          sOut += '<tr valign="top"><td width="10%"><b>ID: </b>'+aData[1]+'</td><td width="30%"><b>Question : </b>'+aData[2]+'</td><td width="20%"><b>Asked By: </b>'+aData[8]+'</td></tr>';
          ...
          sOut += '<tr valign="top"><td width="10%"></td><td width="30%"><b>Keyworks: </b>'+aData[13]+'</td><td width="20%"></td></tr>';
