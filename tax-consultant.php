...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <meta name="description" content="Bass Biz is one of the well known tax consultant in Tamil Nadu, offer sales tax, service tax, central excise and income tax  consulting services"/>
    <meta name="abstract" content="Bass Biz offers tax consulting services in chennai , trichy, salem, tanjayur"/>
    <meta name="keywords" content="tax consultant, tax consultancy, service tax, sales tax, taxation services, excise duty"/>
    ...
    <title> Tax Consultant | Tax Consulting Services | Service Tax | Sales Tax | Bass Biz </title>
    ...
    <div class="envor-content">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="envor-desktop-breadscrubs-inner">
                <a href="index.php">Home</a><i class="fa fa-angle-double-right"></i><a href="services.php">Services</a><i class="fa fa-angle-double-right"></i><a href="#">Tax Consulting</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="envor-section envor-section-align-center">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <h2><strong>TAX CONSULTING</strong></h2>
