...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <title>Events | Bass Biz | Accounting, Internal Auditing service provider in Chennai</title>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="envor-desktop-breadscrubs-inner">
                <a href="../index.php">Home</a><i class="fa fa-angle-double-right"></i><a href="events.php">Events</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-lg-9 col-md-9">
              ...
              <article class="envor-post">
                <?php
                  ...
                  {
                    echo "<header><h3><i class='fa fa-plane'></i><span>".$row['title']."</span></h3></header>";
                    echo "<p><div align='justify'>".$row['description']."</div></p>";
                    $timestamp = $row['start'];
                    echo "<div class='date'><span class='day'>".date('d',strtotime($timestamp))."</span>";
                    echo "<span class='month'>".date('M',strtotime($timestamp)).",".date('y',strtotime($timestamp))."</span></div>";

                    //echo "<p><strong>Date:</strong>".$row['start']."</p>";
                  }
            ...
            <aside class="envor-widget envor-category-widget">
              ...
              <div class="envor-widget-inner">
                <ul>
                  <li>
                    <p><a href="RoC-Filing"><i class="glyphicon glyphicon-folder-open"></i> RoC-Filing</a> <a href="RoC-Filing">
                      <i class="fa fa-rss"></i></a> 
                    </p>
                  </li>
                  <li>
                    <p><a href="Income-Tax"><i class="glyphicon glyphicon-folder-open"></i> Income-Tax</a> <a href="Income-Tax">
                      <i class="fa fa-rss"></i></a> 
                    </p>
                  </li>
                  <li>
                    <p><a href="Service-Tax"><i class="glyphicon glyphicon-folder-open"></i> Service-Tax</a> <a href="Service-Tax">
                      <i class="fa fa-rss"></i></a> 
                    </p>
                  </li> 
                  <li>
                    <p><a href="Sales-Tax"><i class="glyphicon glyphicon-folder-open"></i> Sales-Tax</a> <a href="Sales-Tax">
                      <i class="fa fa-rss"></i></a> 
                    </p>
                  </li> 
                  <li>
                    <p><a href="Excise-Duty"><i class="glyphicon glyphicon-folder-open"></i> Excise-Duty</a> <a href="Excise-Duty">
                      <i class="fa fa-rss"></i></a> 
                    </p>
                  </li> 
                  <li>
                    <p><a href="Customs-Duty"><i class="glyphicon glyphicon-folder-open"></i> Customs-Duty</a> <a href="Customs-Duty">
                      <i class="fa fa-rss"></i></a> 
                    </p>
                  </li> 
                  <li>
                    <p><a href="Others"><i class="glyphicon glyphicon-folder-open"></i> Others</a> <a href="Others">
                      <i class="fa fa-rss"></i></a> 
                    </p>
                  </li>                                                                         
                </ul>
                ...
                <div class="envor-tabs">
                        ...
                        if($result && $result->num_rows > 0)
                        {
                            ...
                            foreach($data as $_year => $_months)
                            {
                                ...
                                foreach($_months as $_month => $_entries)
                                {
                                    ...
                                    {
                                        echo "<li>";
                                        echo "<i class='fa fa-angle-double-right'></i>&nbsp;&nbsp;<a href=\"../blog/{$_entry['url']}\">";
                  ...
                  <article>
                    ...
                    //-->
                      ...
                      ?>
                      <div class="envor-sidebar-comment">
                      <p><a href="../blog/<?php echo $row['url']; ?>"><?php $content=$row['post_title']; 
                      // strip tags to avoid breaking any html
                       $string = strip_tags($content);
    ...
    <script>
      ...
      $(document).ready(function() {
        ...
        $('#calendar').fullCalendar({
          ...
          //events: "assets/calendar/script/get-events.php",
          events: {
            url: '../assets/calendar/script/get-events.php',
            error: function() {
              $('#script-warning').show();
            }
          },
