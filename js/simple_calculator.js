        ...
        var year= y.options[y.selectedIndex].value;
         ...
         if(year=='14_15')
         {
			...
			if(payer=="individual")
				{
					...
					if(type=="female")
					{
						...
						{
							//alert("You don't want to pay tax");							
							var output = 0; 
						...
						else if(income > "200000" && income <= "500000")
						{
							...
							var taxable_income = Math.round(income - 220000);
					...
					if(type=="citizen")
					{
						...
						else if(income > "250000" && income <= "500000")
						{
							...
							var taxable_income = Math.round(income - 270000);
		...
		else if(payer=="foreign_company")
			{
				...
				var tax = Math.round((income/100)*40);
		...
		else
			{
				...
				var tax = Math.round((income/100)*30);
			...
			if(payer=="individual")
				{
					...
					if(type=="citizen")
					{
						...
						else if(income > "300000" && income <= "500000")
						{
							...
							var taxable_income = Math.round(income - 320000);
