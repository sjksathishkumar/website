                ...
                if(type=="s_citizen")
                {
                  ...
                  if(agri_box_value == 0)
                  {
                    ...
                    else if (income > "500000" && income < "1000000") 
                    {
                      ...
                      var total_tax = Math.round(tax); // Tax for 5L< slab + 2 to 5L tax( 30000)
                      ...
                      {                    
                          ...
                          if(income_validate_agri > 10000000)
                          {
                            ...
                            else if (income > "500000" && income < "1000000") 
                            {
                              ...
                              var tax = Math.round(tax); // Tax for 5L< slab 
                            ...
                            else 
                            {
                              ...
                              var tax = Math.round(tax + 100000); // Tax for 10L< slab + 2nd slab tax
                            ...
                            else 
                            {
                              ...
                              var agri_total_tax = Math.round(agri_tax); // Tax for 10L< slab + 2nd slab tax
                          ...
                          else
                          {
                            ...
                            else if (income > "500000" && income < "1000000") 
                            {
                              ...
                              var tax = Math.round(tax); // Tax for 5L< slab + 2 to 5L tax( 30000)
                            ...
                            var agri_tax_input = agri_box_value + 500000;   // Exemption on 2L as per slab 
